...
export class TypedDocumentString<TResult, TVariables> extends String {
	__apiType?:
		| import("@graphql-typed-document-node/core").DocumentTypeDecoration<
				TResult,
				TVariables
		  >
		| undefined;
...
export type QueryProductsPaginatedArgs = {
	...
	customOrderIds?: InputMaybe<Array<Scalars["ID"]["input"]>>;
	limit?: InputMaybe<Scalars["Int"]["input"]>;
...
export type UpdateProductsSortOrderMutation = {
	updateProductsSortOrder: boolean;
};
...
export type CreateBundleMutation = {
	createBundle: { id: string; title: string; slug: string; price: number };
};
...
export type UpdateBundleMutation = {
	updateBundle: { id: string; title: string; slug: string; price: number };
};
...
export type CreateHomepageSectionMutation = {
...
export type CreateShippingConfigMutation = {
...
export type UpdateShippingConfigMutation = {
...
export type CreateTaxConfigMutation = {
	createTaxConfig: {
		id: string;
		name: string;
		rate: number;
		region: string;
		type: string;
		appliedToShipping: boolean | null;
		status: string | null;
	};
};
...
export type UpdateTaxConfigMutation = {
	updateTaxConfig: {
		id: string;
		name: string;
		rate: number;
...
export type UpdateRefundRequestStatusMutation = {
...
export type ProcessStripeRefundMutation = {
	processStripeRefund: {
		id: string;
		status: string;
...
export type GetProductsPaginatedQueryVariables = Exact<{
	...
	customOrderIds?: Array<string | number> | string | number | null | undefined;
}>;

export type GetProductsPaginatedQuery = {
	productsPaginated: {
		totalCount: number;
		totalPages: number;
		items: Array<{
...
export type GetBundleBySlugQuery = {
	bundleBySlug: {
		id: string;
		title: string;
		slug: string;
...
export type CheckoutMutation = {
	checkout: { id: string; status: string; total: number };
};
...
export type GetOrdersQuery = {
	orders: Array<{
		...
		items: Array<{
			...
			price: number;
			quantity: number;
			product: { isbn: string | null } | null;
			bundle: {
				books: Array<{ title: string; isbn: string | null } | null> | null;
			} | null;
		}>;
		shippingAddress: {
			firstName: string;
...
export type GetHeroBannersQuery = {
	heroBanners: Array<{
		id: string;
		title: string;
		subtitle: string | null;
...
export type GetHomepageSectionsQuery = {
...
export type GetShippingConfigsQuery = {
	shippingConfigs: Array<{
		...
		standardFee: number;
		expressFee: number;
		isExpressEnabled: boolean | null;
		freeThreshold: number;
		deliveryTime: string;
		expressDeliveryTime: string | null;
		codFee: number | null;
		status: string | null;
	}>;
};
...
export type GetTaxConfigsQuery = {
	taxConfigs: Array<{
		id: string;
		name: string;
		rate: number;
...
export type CreateCouponMutation = {
	createCoupon: { id: string; code: string };
};
...
export type UpdateCouponMutation = {
	updateCoupon: { id: string; code: string };
};
...
export type GetRefundRequestsQuery = {
...
export type GetRefundRequestQuery = {
	refundRequest: {
		id: string;
		orderId: string;
		userId: string | null;
...
export const useCreateProductMutation = <TError = unknown, TContext = unknown>(
	...
	>({
		...
		mutationFn: (variables?: CreateProductMutationVariables) =>
			customFetcher<CreateProductMutation, CreateProductMutationVariables>(
...
export const useUpdateProductMutation = <TError = unknown, TContext = unknown>(
	...
	>({
		...
		mutationFn: (variables?: UpdateProductMutationVariables) =>
			customFetcher<UpdateProductMutation, UpdateProductMutationVariables>(
...
export const useDeleteProductMutation = <TError = unknown, TContext = unknown>(
	...
	>({
		...
		mutationFn: (variables?: DeleteProductMutationVariables) =>
			customFetcher<DeleteProductMutation, DeleteProductMutationVariables>(
...
>(
	options?: UseMutationOptions<
		UpdateProductsSortOrderMutation,
		TError,
		UpdateProductsSortOrderMutationVariables,
		TContext
	>
) => {
	return useMutation<
	...
	>({
		...
		mutationFn: (variables?: UpdateProductsSortOrderMutationVariables) =>
			customFetcher<
				UpdateProductsSortOrderMutation,
				UpdateProductsSortOrderMutationVariables
			>(UpdateProductsSortOrderDocument, variables)(),
		...options,
	});
};
...
export const useCreateBundleMutation = <TError = unknown, TContext = unknown>(
	options?: UseMutationOptions<
	...
	>({
		...
		mutationFn: (variables?: CreateBundleMutationVariables) =>
			customFetcher<CreateBundleMutation, CreateBundleMutationVariables>(
...
export const useUpdateBundleMutation = <TError = unknown, TContext = unknown>(
	options?: UseMutationOptions<
	...
	>({
		...
		mutationFn: (variables?: UpdateBundleMutationVariables) =>
			customFetcher<UpdateBundleMutation, UpdateBundleMutationVariables>(
...
export const useDeleteBundleMutation = <TError = unknown, TContext = unknown>(
	options?: UseMutationOptions<
	...
	>({
		...
		mutationFn: (variables?: DeleteBundleMutationVariables) =>
			customFetcher<DeleteBundleMutation, DeleteBundleMutationVariables>(
...
>(
	options?: UseMutationOptions<
		...
		TError,
		CreateHeroBannerMutationVariables,
		TContext
	>
) => {
	return useMutation<
	...
	>({
		...
		mutationFn: (variables?: CreateHeroBannerMutationVariables) =>
			customFetcher<
				CreateHeroBannerMutation,
				CreateHeroBannerMutationVariables
			>(CreateHeroBannerDocument, variables)(),
		...options,
	});
};
...
>(
	options?: UseMutationOptions<
		...
		TError,
		DeleteHeroBannerMutationVariables,
		TContext
	>
) => {
	return useMutation<
	...
	>({
		...
		mutationFn: (variables?: DeleteHeroBannerMutationVariables) =>
			customFetcher<
				DeleteHeroBannerMutation,
				DeleteHeroBannerMutationVariables
			>(DeleteHeroBannerDocument, variables)(),
		...options,
	});
};
...
>(
	options?: UseMutationOptions<
		...
		TError,
		UpdateHeroBannerMutationVariables,
		TContext
	>
) => {
	return useMutation<
	...
	>({
		...
		mutationFn: (variables?: UpdateHeroBannerMutationVariables) =>
			customFetcher<
				UpdateHeroBannerMutation,
				UpdateHeroBannerMutationVariables
			>(UpdateHeroBannerDocument, variables)(),
		...options,
	});
};
...
export const useCreatePopupMutation = <TError = unknown, TContext = unknown>(
	options?: UseMutationOptions<
		CreatePopupMutation,
		TError,
	...
	>({
		...
		mutationFn: (variables?: CreatePopupMutationVariables) =>
			customFetcher<CreatePopupMutation, CreatePopupMutationVariables>(
				CreatePopupDocument,
				variables
			)(),
		...options,
...
export const useUpdatePopupMutation = <TError = unknown, TContext = unknown>(
	options?: UseMutationOptions<
		UpdatePopupMutation,
		TError,
	...
	>({
		...
		mutationFn: (variables?: UpdatePopupMutationVariables) =>
			customFetcher<UpdatePopupMutation, UpdatePopupMutationVariables>(
				UpdatePopupDocument,
				variables
			)(),
		...options,
...
export const useDeletePopupMutation = <TError = unknown, TContext = unknown>(
	options?: UseMutationOptions<
		DeletePopupMutation,
		TError,
		DeletePopupMutationVariables,
		TContext
	>
) => {
	return useMutation<
	...
	>({
		...
		mutationFn: (variables?: DeletePopupMutationVariables) =>
			customFetcher<DeletePopupMutation, DeletePopupMutationVariables>(
				DeletePopupDocument,
				variables
			)(),
		...options,
...
>(
	options?: UseMutationOptions<
		CreateHomepageSectionMutation,
		TError,
		CreateHomepageSectionMutationVariables,
		TContext
	>
) => {
	return useMutation<
	...
	>({
		...
		mutationFn: (variables?: CreateHomepageSectionMutationVariables) =>
			customFetcher<
				CreateHomepageSectionMutation,
				CreateHomepageSectionMutationVariables
			>(CreateHomepageSectionDocument, variables)(),
		...options,
	});
};
...
>(
	options?: UseMutationOptions<
		DeleteHomepageSectionMutation,
		TError,
		DeleteHomepageSectionMutationVariables,
		TContext
	>
) => {
	return useMutation<
	...
	>({
		...
		mutationFn: (variables?: DeleteHomepageSectionMutationVariables) =>
			customFetcher<
				DeleteHomepageSectionMutation,
				DeleteHomepageSectionMutationVariables
			>(DeleteHomepageSectionDocument, variables)(),
		...options,
	});
};
...
>(
	options?: UseMutationOptions<
		CreateShippingConfigMutation,
		TError,
		CreateShippingConfigMutationVariables,
		TContext
	>
) => {
	return useMutation<
	...
	>({
		...
		mutationFn: (variables?: CreateShippingConfigMutationVariables) =>
			customFetcher<
				CreateShippingConfigMutation,
				CreateShippingConfigMutationVariables
			>(CreateShippingConfigDocument, variables)(),
		...options,
	});
};
...
>(
	options?: UseMutationOptions<
		DeleteShippingConfigMutation,
		TError,
		DeleteShippingConfigMutationVariables,
		TContext
	>
) => {
	return useMutation<
	...
	>({
		...
		mutationFn: (variables?: DeleteShippingConfigMutationVariables) =>
			customFetcher<
				DeleteShippingConfigMutation,
				DeleteShippingConfigMutationVariables
			>(DeleteShippingConfigDocument, variables)(),
		...options,
	});
};
...
>(
	options?: UseMutationOptions<
		UpdateShippingConfigMutation,
		TError,
		UpdateShippingConfigMutationVariables,
		TContext
	>
) => {
	return useMutation<
	...
	>({
		...
		mutationFn: (variables?: UpdateShippingConfigMutationVariables) =>
			customFetcher<
				UpdateShippingConfigMutation,
				UpdateShippingConfigMutationVariables
			>(UpdateShippingConfigDocument, variables)(),
		...options,
	});
};
...
>(
	options?: UseMutationOptions<
		...
		TError,
		CreateTaxConfigMutationVariables,
		TContext
	>
) => {
	return useMutation<
	...
	>({
		...
		mutationFn: (variables?: CreateTaxConfigMutationVariables) =>
			customFetcher<CreateTaxConfigMutation, CreateTaxConfigMutationVariables>(
				CreateTaxConfigDocument,
				variables
			)(),
		...options,
	});
...
>(
	options?: UseMutationOptions<
		...
		TError,
		DeleteTaxConfigMutationVariables,
		TContext
	>
) => {
	return useMutation<
	...
	>({
		...
		mutationFn: (variables?: DeleteTaxConfigMutationVariables) =>
			customFetcher<DeleteTaxConfigMutation, DeleteTaxConfigMutationVariables>(
				DeleteTaxConfigDocument,
				variables
			)(),
		...options,
	});
...
>(
	options?: UseMutationOptions<
		...
		TError,
		UpdateTaxConfigMutationVariables,
		TContext
	>
) => {
	return useMutation<
	...
	>({
		...
		mutationFn: (variables?: UpdateTaxConfigMutationVariables) =>
			customFetcher<UpdateTaxConfigMutation, UpdateTaxConfigMutationVariables>(
				UpdateTaxConfigDocument,
				variables
			)(),
		...options,
	});
...
export const useCreateCategoryMutation = <TError = unknown, TContext = unknown>(
	...
	>({
		...
		mutationFn: (variables?: CreateCategoryMutationVariables) =>
			customFetcher<CreateCategoryMutation, CreateCategoryMutationVariables>(
...
export const useUpdateCategoryMutation = <TError = unknown, TContext = unknown>(
	...
	>({
		...
		mutationFn: (variables?: UpdateCategoryMutationVariables) =>
			customFetcher<UpdateCategoryMutation, UpdateCategoryMutationVariables>(
...
export const useDeleteCategoryMutation = <TError = unknown, TContext = unknown>(
	...
	>({
		...
		mutationFn: (variables?: DeleteCategoryMutationVariables) =>
			customFetcher<DeleteCategoryMutation, DeleteCategoryMutationVariables>(
...
>(
	...
	>({
		...
		mutationFn: (variables?: UpdateOrderStatusMutationVariables) =>
			customFetcher<
				UpdateOrderStatusMutation,
				UpdateOrderStatusMutationVariables
			>(UpdateOrderStatusDocument, variables)(),
		...options,
	});
};
...
>(
	...
	>({
		...
		mutationFn: (variables?: CreateRefundRequestMutationVariables) =>
			customFetcher<
				CreateRefundRequestMutation,
				CreateRefundRequestMutationVariables
			>(CreateRefundRequestDocument, variables)(),
		...options,
	});
};
...
>(
	options?: UseMutationOptions<
		UpdateRefundRequestStatusMutation,
		TError,
		UpdateRefundRequestStatusMutationVariables,
		TContext
	>
) => {
	return useMutation<
	...
	>({
		...
		mutationFn: (variables?: UpdateRefundRequestStatusMutationVariables) =>
			customFetcher<
				UpdateRefundRequestStatusMutation,
				UpdateRefundRequestStatusMutationVariables
			>(UpdateRefundRequestStatusDocument, variables)(),
		...options,
	});
};
...
>(
	options?: UseMutationOptions<
		ProcessStripeRefundMutation,
		TError,
		ProcessStripeRefundMutationVariables,
		TContext
	>
) => {
	return useMutation<
	...
	>({
		...
		mutationFn: (variables?: ProcessStripeRefundMutationVariables) =>
			customFetcher<
				ProcessStripeRefundMutation,
				ProcessStripeRefundMutationVariables
			>(ProcessStripeRefundDocument, variables)(),
		...options,
	});
};

export const GetProductsPaginatedDocument = new TypedDocumentString(`
    query GetProductsPaginated($category: String, $q: String, $sort: String, $page: Int, $limit: Int, $customOrderIds: [ID!]) {
  productsPaginated(
    category: $category
    q: $q
    sort: $sort
...
export const useGetProductsPaginatedQuery = <
	TData = GetProductsPaginatedQuery,
	TError = unknown,
>(
	variables?: GetProductsPaginatedQueryVariables,
	options?: Omit<
		UseQueryOptions<GetProductsPaginatedQuery, TError, TData>,
		"queryKey"
	> & {
	...
	return useQuery<GetProductsPaginatedQuery, TError, TData>({
		queryKey:
			variables === undefined
				? ["GetProductsPaginated"]
				: ["GetProductsPaginated", variables],
		queryFn: customFetcher<
			GetProductsPaginatedQuery,
			GetProductsPaginatedQueryVariables
		>(GetProductsPaginatedDocument, variables),
		...options,
	});
};
...
export const useGetProductsQuery = <TData = GetProductsQuery, TError = unknown>(
	...
	return useQuery<GetProductsQuery, TError, TData>({
		...
		queryFn: customFetcher<GetProductsQuery, GetProductsQueryVariables>(
			GetProductsDocument,
			variables
		),
		...options,
...
>(
	...
	options?: Omit<
		UseQueryOptions<GetProductBySlugQuery, TError, TData>,
		"queryKey"
	> & {
		queryKey?: UseQueryOptions<
	...
	return useQuery<GetProductBySlugQuery, TError, TData>({
		...
		>(GetProductBySlugDocument, variables),
		...options,
	});
};
...
export const useGetBundlesQuery = <TData = GetBundlesQuery, TError = unknown>(
	variables?: GetBundlesQueryVariables,
	options?: Omit<
		UseQueryOptions<GetBundlesQuery, TError, TData>,
		"queryKey"
	> & { queryKey?: UseQueryOptions<GetBundlesQuery, TError, TData>["queryKey"] }
) => {
	return useQuery<GetBundlesQuery, TError, TData>({
		queryKey:
			variables === undefined ? ["GetBundles"] : ["GetBundles", variables],
		queryFn: customFetcher<GetBundlesQuery, GetBundlesQueryVariables>(
			GetBundlesDocument,
			variables
		),
		...options,
...
>(
	...
	options?: Omit<
		UseQueryOptions<GetBundleBySlugQuery, TError, TData>,
		"queryKey"
	> & {
		queryKey?: UseQueryOptions<GetBundleBySlugQuery, TError, TData>["queryKey"];
	}
) => {
	return useQuery<GetBundleBySlugQuery, TError, TData>({
		queryKey: ["GetBundleBySlug", variables],
		queryFn: customFetcher<GetBundleBySlugQuery, GetBundleBySlugQueryVariables>(
			GetBundleBySlugDocument,
			variables
		),
		...options,
	});
...
export const useCheckoutMutation = <TError = unknown, TContext = unknown>(
	...
	>({
		...
		mutationFn: (variables?: CheckoutMutationVariables) =>
			customFetcher<CheckoutMutation, CheckoutMutationVariables>(
				CheckoutDocument,
				variables
			)(),
		...options,
...
export const useGetOrdersQuery = <TData = GetOrdersQuery, TError = unknown>(
	...
	options?: Omit<UseQueryOptions<GetOrdersQuery, TError, TData>, "queryKey"> & {
		queryKey?: UseQueryOptions<GetOrdersQuery, TError, TData>["queryKey"];
	}
) => {
	return useQuery<GetOrdersQuery, TError, TData>({
		queryKey:
			variables === undefined ? ["GetOrders"] : ["GetOrders", variables],
		queryFn: customFetcher<GetOrdersQuery, GetOrdersQueryVariables>(
			GetOrdersDocument,
			variables
		),
		...options,
...
>(
	...
	options?: Omit<
		UseQueryOptions<GetHeroBannersQuery, TError, TData>,
		"queryKey"
	> & {
		queryKey?: UseQueryOptions<GetHeroBannersQuery, TError, TData>["queryKey"];
	}
) => {
	return useQuery<GetHeroBannersQuery, TError, TData>({
		queryKey:
			variables === undefined
				? ["GetHeroBanners"]
				: ["GetHeroBanners", variables],
		queryFn: customFetcher<GetHeroBannersQuery, GetHeroBannersQueryVariables>(
...
export const useGetPopupsQuery = <TData = GetPopupsQuery, TError = unknown>(
	variables?: GetPopupsQueryVariables,
	options?: Omit<UseQueryOptions<GetPopupsQuery, TError, TData>, "queryKey"> & {
		queryKey?: UseQueryOptions<GetPopupsQuery, TError, TData>["queryKey"];
	}
) => {
	return useQuery<GetPopupsQuery, TError, TData>({
		queryKey:
			variables === undefined ? ["GetPopups"] : ["GetPopups", variables],
		queryFn: customFetcher<GetPopupsQuery, GetPopupsQueryVariables>(
			GetPopupsDocument,
			variables
		),
		...options,
...
>(
	...
	options?: Omit<
		UseQueryOptions<GetHomepageSectionsQuery, TError, TData>,
		"queryKey"
	> & {
		queryKey?: UseQueryOptions<
	...
	return useQuery<GetHomepageSectionsQuery, TError, TData>({
		queryKey:
			variables === undefined
				? ["GetHomepageSections"]
				: ["GetHomepageSections", variables],
		queryFn: customFetcher<
			GetHomepageSectionsQuery,
			GetHomepageSectionsQueryVariables
		>(GetHomepageSectionsDocument, variables),
		...options,
	});
};
...
export const useGetUsersQuery = <TData = GetUsersQuery, TError = unknown>(
	...
	return useQuery<GetUsersQuery, TError, TData>({
		...
		queryFn: customFetcher<GetUsersQuery, GetUsersQueryVariables>(
			GetUsersDocument,
			variables
		),
		...options,
...
>(
	...
	options?: Omit<
		UseQueryOptions<GetShippingConfigsQuery, TError, TData>,
		"queryKey"
	> & {
		queryKey?: UseQueryOptions<
			GetShippingConfigsQuery,
			TError,
			TData
		>["queryKey"];
	}
	...
	return useQuery<GetShippingConfigsQuery, TError, TData>({
		queryKey:
			variables === undefined
				? ["GetShippingConfigs"]
				: ["GetShippingConfigs", variables],
		queryFn: customFetcher<
			GetShippingConfigsQuery,
			GetShippingConfigsQueryVariables
		>(GetShippingConfigsDocument, variables),
		...options,
	});
};
...
>(
	...
	options?: Omit<
		UseQueryOptions<GetTaxConfigsQuery, TError, TData>,
		"queryKey"
	> & {
		queryKey?: UseQueryOptions<GetTaxConfigsQuery, TError, TData>["queryKey"];
	}
) => {
	return useQuery<GetTaxConfigsQuery, TError, TData>({
		queryKey:
			variables === undefined
				? ["GetTaxConfigs"]
				: ["GetTaxConfigs", variables],
		queryFn: customFetcher<GetTaxConfigsQuery, GetTaxConfigsQueryVariables>(
			GetTaxConfigsDocument,
			variables
		),
		...options,
	});
...
>(
	...
	options?: Omit<
		UseQueryOptions<GetCategoriesQuery, TError, TData>,
		"queryKey"
	> & {
		queryKey?: UseQueryOptions<GetCategoriesQuery, TError, TData>["queryKey"];
	}
) => {
	return useQuery<GetCategoriesQuery, TError, TData>({
		...
		queryFn: customFetcher<GetCategoriesQuery, GetCategoriesQueryVariables>(
...
>(
	...
	options?: Omit<
		UseQueryOptions<GetOrderByIdQuery, TError, TData>,
		"queryKey"
	> & {
		queryKey?: UseQueryOptions<GetOrderByIdQuery, TError, TData>["queryKey"];
	}
) => {
	return useQuery<GetOrderByIdQuery, TError, TData>({
		queryKey: ["GetOrderById", variables],
		queryFn: customFetcher<GetOrderByIdQuery, GetOrderByIdQueryVariables>(
...
export const useGetCouponsQuery = <TData = GetCouponsQuery, TError = unknown>(
	variables?: GetCouponsQueryVariables,
	options?: Omit<
		UseQueryOptions<GetCouponsQuery, TError, TData>,
		"queryKey"
	> & { queryKey?: UseQueryOptions<GetCouponsQuery, TError, TData>["queryKey"] }
) => {
	return useQuery<GetCouponsQuery, TError, TData>({
		queryKey:
			variables === undefined ? ["GetCoupons"] : ["GetCoupons", variables],
		queryFn: customFetcher<GetCouponsQuery, GetCouponsQueryVariables>(
			GetCouponsDocument,
			variables
		),
		...options,
...
export const useGetCouponQuery = <TData = GetCouponQuery, TError = unknown>(
	variables: GetCouponQueryVariables,
	options?: Omit<UseQueryOptions<GetCouponQuery, TError, TData>, "queryKey"> & {
		queryKey?: UseQueryOptions<GetCouponQuery, TError, TData>["queryKey"];
	}
) => {
	return useQuery<GetCouponQuery, TError, TData>({
		queryKey: ["GetCoupon", variables],
		queryFn: customFetcher<GetCouponQuery, GetCouponQueryVariables>(
			GetCouponDocument,
			variables
		),
		...options,
...
>(
	...
	options?: Omit<
		UseQueryOptions<ValidateCouponQuery, TError, TData>,
		"queryKey"
	> & {
		queryKey?: UseQueryOptions<ValidateCouponQuery, TError, TData>["queryKey"];
	}
) => {
	return useQuery<ValidateCouponQuery, TError, TData>({
		queryKey: ["ValidateCoupon", variables],
		queryFn: customFetcher<ValidateCouponQuery, ValidateCouponQueryVariables>(
...
export const useCreateCouponMutation = <TError = unknown, TContext = unknown>(
	options?: UseMutationOptions<
	...
	>({
		...
		mutationFn: (variables?: CreateCouponMutationVariables) =>
			customFetcher<CreateCouponMutation, CreateCouponMutationVariables>(
...
export const useUpdateCouponMutation = <TError = unknown, TContext = unknown>(
	...
	>({
		...
		mutationFn: (variables?: UpdateCouponMutationVariables) =>
			customFetcher<UpdateCouponMutation, UpdateCouponMutationVariables>(
...
export const useDeleteCouponMutation = <TError = unknown, TContext = unknown>(
	...
	>({
		...
		mutationFn: (variables?: DeleteCouponMutationVariables) =>
			customFetcher<DeleteCouponMutation, DeleteCouponMutationVariables>(
...
>(
	...
	options?: Omit<
		UseQueryOptions<GetRefundRequestsQuery, TError, TData>,
		"queryKey"
	> & {
		queryKey?: UseQueryOptions<
	...
	return useQuery<GetRefundRequestsQuery, TError, TData>({
		queryKey:
			variables === undefined
				? ["GetRefundRequests"]
				: ["GetRefundRequests", variables],
		queryFn: customFetcher<
			GetRefundRequestsQuery,
			GetRefundRequestsQueryVariables
		>(GetRefundRequestsDocument, variables),
		...options,
	});
};
...
>(
	...
	options?: Omit<
		UseQueryOptions<GetRefundRequestQuery, TError, TData>,
		"queryKey"
	> & {
		queryKey?: UseQueryOptions<
			GetRefundRequestQuery,
			TError,
			TData
		>["queryKey"];
	}
	...
	return useQuery<GetRefundRequestQuery, TError, TData>({
		...
		queryFn: customFetcher<
			GetRefundRequestQuery,
			GetRefundRequestQueryVariables
		>(GetRefundRequestDocument, variables),
		...options,
	});
};
