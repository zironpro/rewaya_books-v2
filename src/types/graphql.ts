...
export type GetAdminDashboardStatsQuery = { adminDashboardStats: { totalSales: number, totalOrders: number, activeCustomers: number, totalBooks: number } };
...
export type GetProductsPaginatedQuery = { productsPaginated: { totalCount: number, totalPages: number, items: Array<{ id: string, title: string, slug: string, author: string | null, description: string | null, price: number, originalPrice: number | null, stock: number | null, coverImage: string | null, images: Array<string | null> | null, categoryId: string | null, categorySlug: string | null, categoryName: string | null, categoryIds: Array<string | null> | null, isbn: string | null, pages: number | null, language: string | null, format: string | null, ribbon: string | null, publisher: string | null, createdAt: string | null, updatedAt: string | null, sortOrder: number | null, categories: Array<{ id: string, name: string, slug: string } | null> | null }> } };
...
export const useGetAdminDashboardStatsQuery = <
    ...
    queryFn: customFetcher<GetAdminDashboardStatsQuery, GetAdminDashboardStatsQueryVariables>(GetAdminDashboardStatsDocument, variables),
    ...options
  }
    )};
...
export const useGetProductsPaginatedQuery = <
    ...
    >(
      ...
      options?: Omit<UseQueryOptions<GetProductsPaginatedQuery, TError, TData>, 'queryKey'> & { queryKey?: UseQueryOptions<GetProductsPaginatedQuery, TError, TData>['queryKey'] }
    ) => {
    
    return useQuery<GetProductsPaginatedQuery, TError, TData>(
      {
    queryKey: variables === undefined ? ['GetProductsPaginated'] : ['GetProductsPaginated', variables],
    queryFn: customFetcher<GetProductsPaginatedQuery, GetProductsPaginatedQueryVariables>(GetProductsPaginatedDocument, variables),
    ...options
  }
    )};
